...
export default function ReportPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-3xl font-semibold mb-6 text-gray-200">Report waste</h1>
      ...
      <h2 className="text-3xl font-semibold mb-6 text-gray-200">Recent Reports</h2>
      <div className="bg-gray-950 rounded-2xl shadow-lg overflow-hidden">

...
export default function CollectPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      <h1 className="text-3xl font-semibold mb-6 text-gray-200">Waste Collection Tasks</h1>
        ...
        <>
          <div className="space-y-4">
            {paginatedTasks.map(task => (
              <div key={task.id} className="bg-gray-950 p-4 rounded-lg shadow-sm border border-gray-300">
                <div className="flex justify-between items-center mb-2">
                  <h2 className="text-lg font-medium text-gray-200 flex items-center">
                    <MapPin className="w-5 h-5 mr-2 text-gray-200" />
                    {task.location}
                  </h2>
                  <StatusBadge status={task.status} />
                </div>
                <div className="grid grid-cols-3 gap-2 text-sm text-gray-200 mb-3">
                  <div className="flex items-center relative">
                    <Trash2 className="w-4 h-4 mr-2 text-gray-200" />
                    <span 
                    ...
                    {hoveredWasteType === task.wasteType && (
                      <div className="absolute left-0 top-full mt-1 p-2 bg-gray-200 text-white text-xs rounded shadow-lg z-10">
                        {task.wasteType}
                      </div>
                    )}
                  </div>
                  <div className="flex items-center">
                    <Weight className="w-4 h-4 mr-2 text-gray-200" />
                    {task.amount}
                  </div>
                  <div className="flex items-center">
